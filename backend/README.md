...
## Project Structure
    ...
    ├── testapiautosetting_116230  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_116230`
...
2. Clone this repo and `cd testapiautosetting_116230`
